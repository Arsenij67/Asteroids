...
{
    public class EntitiesGenerationPresenter
    {
        public event Action<EnemyController, BaseEnemy> OnEnemySpawned;
        public event Action<SpaceShipPresenter> OnShipSpawned;
        ...
        private SpaceShipPresenter GenerateShip(SpaceShipPresenter shipControllerPrefab)
        {
            SpaceShipPresenter playerShip = _resourceLoaderService.Instantiate(shipControllerPrefab, _generationData.PointShipToGenerate, Quaternion.identity).GetComponent<SpaceShipPresenter>();
