...
namespace Asteroid.Services.UnityCloud
{
    public class CloudDataPresenter
    {
        ...
        public async void AddCountDeadEnemies(int enemiesToAdd)
        {
            ...
            UpdateLastTimeSave(_remoteSavable.GetKeyLastModified(CloudKeyData.COINS_COUNT));
        }
        ...
        {
            _shopUI?.UpdateCountCoins(CountCoins+ ADDED_100_COINS);
        }
        ...
        private void UpdateLastTimeSave(DateTime? lastTimeSave)
        {
            _dataSave[CloudKeyData.LAST_SAVE_TIME] = lastTimeSave;
        }
